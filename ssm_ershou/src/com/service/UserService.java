...
public class UserService {
	...
	public List<Users> gett(String username,int page, int rows){
        List<Users> list = userDao.getListByName(username, rows * (page-1), rows);
		return list;
	}
	...
	public long getByUsername(String name) {
		// TODO 自动生成的方法存根
		return userDao.getTotalByName(name);
	}

	public List<Users> getListByName(String name, int page, int rows) {
		// TODO 自动生成的方法存根
		return userDao.getListByName(name, page, rows);
	}
