...
<!-- 					<h1 class="navbar-brand" style="color:red;font-size:39px;text-align:center"><a href="index">西柚校园二手商城</a></h1>
 -->				</div>
				<!--navbar-header-->
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li style="margin: 0 0 -1px -1px;"><a href="top?typeid=3" <c:if test="${flag==8}">class="active"</c:if>>新品</a></li>
    ...
    <div style="width:200px;height:200px;position:fixed;bottom:200px;right:100px; border:1px solid #f00;background-color:#ffd800; z-index:101;visibility:hidden;">
